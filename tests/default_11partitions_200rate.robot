...
*** Variables ***
${SERVER_CMD}               python3.6 scripts/server.py --ipaddress 127.0.0.1 --port 5555 --partitions 11 --rate_limit 200
${CLIENT_CMD}               python3.6 scripts/reverse_engineering_client.py --ipaddress 127.0.0.1 --port 5555 --rate_limit 200
